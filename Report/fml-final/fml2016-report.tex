...
\begin{thebibliography}{1}
	...
	\bibitem{Wang} C. Wang, D. Blei, and L. Fei-Fei. 2009. Simultaneous image classification and annotation. \emph{Proc. CVPR}. 
	
	\bibitem{Blei} Blei, David. 2012. Probabilistic topic models. In \emph{Communications of the ACM 55(4)}, pages 77-84.
	...
	\bibitem{Agarwal} Apoorv Agarwal, Boyi Xie, Ilia Vovsha, Owen Rambow, and Rebecca Passonneau. 2011. Sentiment analysis of Twitter data. In \emph{Proceedings of the Workshop on Language in Social Media}, pages 30-38.
	
	\bibitem{Hong} Hong, L., and Davison, B. D. 2010. Empirical study of topic modeling in twitter. In \emph{Proc. First Workshop on Social Media Analytics}, SOMA ’10, pages 80-88. NYC, NY, USA: ACM
	
	\bibitem{Nguyen} D. Q. Nguyen, R. Billingsley, L. Du, and M. Johnson. Improving topic models with latent feature word representations. \emph{TACL, 2015.
	}
